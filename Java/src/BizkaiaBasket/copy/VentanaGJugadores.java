...
public class VentanaGJugadores extends JFrame {
	...
	public VentanaGJugadores() {
		...
		btnCrear.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GJugadores.CrearJugador(txtDNI.getText(), txtNombre.getText(), txtApellidos.getText(), txtEquipo.getText());
				Limpiar();
			}
		});
		...
		tblGJugadores.setModel(GJugadores.jugadores);
	...
	public static String getTxtDNI() {
	...
	public static String  getTxtApellidos() {
		return txtApellidos.getText();
	}

	public static String  getTxtEquipo() {
		return txtEquipo.getText();
	}
	
	public static JTable getTblGJugadores() {
		return tblGJugadores;
	}
